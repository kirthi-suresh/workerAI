...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/workerar
```

A live public deployment of this template is available at [https://workerar.templates.workers.dev](https://workerar.templates.workers.dev)
